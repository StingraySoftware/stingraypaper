...
GX 339--4 is a black hole in a low-mass X-ray binary \citep{Hynesetal03}. 
...
For this example we use an Rossi X-ray Timing Explorer (RXTE) Proportional Counter Array (PCA)  observation in NASA's High Energy Astrophysics Science Archive Research Center (HEASARC) from the 2010 outburst of GX 339--4 \citep{Yamaokaetal10}.
